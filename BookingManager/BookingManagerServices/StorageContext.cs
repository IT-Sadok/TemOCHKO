...
public class StorageContext
{
    ...
    public List<ApartmentDBModel> GetAllApartments()
    {
        return _apartmentDbModelsList;
    }
    ...
    public void AddHostAtIndex(int index, HostDBModel host)
    {
        _hostDbModelsList.Insert(index, host);
    }
